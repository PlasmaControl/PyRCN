...
try:
    sequential_search = load(
        "../sequential_search_speech_timit_km_esn_attention_-1_1_rec_0_1"
        ".joblib")
...
for params in ParameterGrid(param_grid):
    ...
    try:
        cv = load("../speech_timit_km_esn_attention_-1_1_rec_0_1_"
        ...
        dump(cv, "../speech_timit_km_esn_attention_-1_1_rec_0_1_" +
             str(params["hidden_layer_size"]) + ".joblib")
