...
# ## Introduction
# 
# This notebook adapts one reference experiment for note prediction using ESNs from
# ([https://arxiv.org/abs/1812.11527](https://arxiv.org/abs/1812.11527)) to PyRCN
# and shows that introducing bidirectional ESNs significantly improves the results
# in terms of Accuracy, already for rather small networks.
# 
# The tutorial is based on numpy, scikit-learn, joblib and PyRCN.
# We are using the ESNRegressor, because we further process the outputs of the ESN.
...
# ## Set up a basic ESN
# 
# To develop an ESN model for this task, we need to tune several hyper-parameters,
...
# ## Test the ESN
# 
# In the test case, we train the ESN using the entire training set as seen before.
# Next, we compute the predicted outputs on the training and test set
